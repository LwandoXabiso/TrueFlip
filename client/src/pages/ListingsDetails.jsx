...
import { ArrowLeftIcon, ArrowUpRightFromSquareIcon, Calendar, 
CheckCircle, ChevronLeftIcon, ChevronRightIcon, Eye, LineChart, 
LoaderIcon, MapPin, MessageSquareMoreIcon, ShoppingBagIcon, 
  ...
  return listing ? (
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex items-start max-md:flex-col gap-10'>
        <div className='flex-1 max-md:w-full'>
          ...
          <div className='flex flex-col md:flex-row md:items-end md:justify-between gap-4'>
            ...
            <div className='flex items-start gap-3'>
              <div className='p-2 rounded-none'>{platformIcons[listing.platform]}</div>
              <div>
                <h2 className='flex items-center gap-2 text-xl font-semibold text-gray-800'>{listing.title}
                <Link target='_blank' to={profileLink}>
                  <ArrowUpRightFromSquareIcon className='size-4 hover:text-gray-500'/>
                </Link>
                </h2>
                <p>
                ...
                <div className='flex gap-2 mt-2'>
                  {listing.verified && (
                    <span className='flex items-center text-xs bg-indigo-50 text-green-600 px-2 py-2 rouunded-none'>
                      <CheckCircle className='w-3 h-3 mr-1'/>
                      Verified
                    </span>
                  )}
                  {listing.monetized && (
                    <span className='flex items-center text-xs bg-blue-50 text-blue-600 px-2 py-2 rouunded-none'>
                      <span className="w-3 h-3 mr-1 font-medium">{currency}</span>
                      Monetized
                    </span>
                  )}
                </div>
            ...
            <div className='text-right'>
              ...
              <p className='text-sm text-gray-500'>ZAR</p>
            ...
            {/* Screenshot section */}
            {images?.length > 0 && (
              <div className='bg-white rounded-none border border-gray-200 mb-5 overflow-hidden'>
                <div className='p-4'>
                ...
                <div className='relative w-full aspect-video overflow-hidden'>
                  ...
                  {/* Navigate Button */}
                  <button onClick={prevSlide} className='absolute left-3 top-1/2 -translate-y-1/2 gb-white/70 hover:gb-white p-2 rounded-full shadow'>
                    <ChevronLeftIcon className='w-5 h-5 text-gray-700'/>
                  </button>

                  <button onClick={nextSlide} className='absolute right-3 top-1/2 -translate-y-1/2 gb-white/70 hover:gb-white p-2 rounded-full shadow'>
            ...
            {/* Account Metrics */}
            <div className='bg-white rounded-none bortder border-gray-200 mb-5'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4 text-center'>
                ...
                <div>
                  ...
                  <p className='font-semibold text-gray-800'>
                    {listing.montly_views?.toLocaleString()}
                  </p>
                  <p className='text-xs text-gray-500'>Montly Views</p>
                </div>
                <div>
            ...
            {/* Description */}
            <div className='bg-white rounded-none border border-gray-200 mb-5'>
              <div className='p-4 bborder-b border-gray-100'>
            ...
            <div className='bg-white rounded-none border border-gray-200 mb-5'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6 p-4 text-sm'>
                <div>
                  ...
                  <p className='font-medium capitlize'>{listing.niche}</p>
                </div>
                <div>
        ...
        <div className='bg-white min-w-full md:min-w-[370px] rounded-none border border-gray-200 p-5 max-md:mb-10'>
          <h4 className='font-semibold text-gray-800 mb-5'>Seller Information</h4>
          ...
          <div className='flex items-center justify-between text-sm text-gray-600 mb-4'>
            <p>Member Since <span>{new Date(listing.owner?.createdAt).toLocaleDateString()}</span></p>
          </div>
          <button onClick={loadChatbox} className='w-full bg-gradient-to-r from-black to-[#748298] text-white py-2 rounded-none hover:bg-gradient-to-r from-black to-[#748298] transition text-sm font-medium flex items-center justify-center gap-2'>
            <MessageSquareMoreIcon className='size-4'/> Chat
          </button>

          {listing.isCredentialChanged && (
            <button onClick={purchaseAccount} className='w-full mt-2 bg-gradient-to-r from-black to-[#748298] text-white py-2 rounded-none hover:bg-gradient-to-r from-black to-[#748298] transition text-sm font-medium flex items-center justify-center gap-2'>
      ...
      <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
        <p className='text-sm text-gray-500'>
          Copyright  © 2025 <span className='text-gray-600'> Summit Sales </span>  All Right Reserved.
        </p>
      </div>
