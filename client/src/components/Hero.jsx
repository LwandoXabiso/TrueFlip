...
function Hero() {
    ...
    const onSubmitHandler = (e) => {
        e.preventDefault()
        navigate(`/marketplace?search=${input}`) //47:56
  ...
  return (
     <>
            ...
            {/* <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800 border-x border-dashed border-zinc-200 min-h-screen"> */}
                ...
                <h1 className="text-4xl md:text-6xl font-semibold max-w-lg md:max-w-2xl text-center mt-4 leading-tight md:leading-tight">
                     ...
                     <span className="relative bg-gradient-to-r from-black to-[#748298] bg-clip-text text-transparent">
                    Social
                ...
                <span className="bg-gradient-to-r from-black to-[#748298] bg-clip-text text-transparent">
                Profiles
                 </span>{" "}
                ...
                <form onSubmit={onSubmitHandler} className='w-full flex justify-center group'>
                    <label className='border border-gray-400 rounded-none p-1 flex items-center w-full max-w-md'>
                        ...
                        {/* <button className='bg-indigo-600 text-white p-3 px-6 rounded-none cursor-pointer'> Search </button> */}
                        <button className='bg-gradient-to-r from-black to-[#748298] text-white p-3 px-6 rounded-none cursor-pointer'> Search </button>
                    </label>
                </form>
            </div>
        </>
